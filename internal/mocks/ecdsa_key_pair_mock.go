...
// ParseECDSAPrivateKey provides a mock function with given fields: pemKey
func (_m *EcdsaKeyPairMock) ParseECDSAPrivateKey(pemKey string) (*ecdsa.PrivateKey, error) {
...
func (_c *EcdsaKeyPairMock_ParseECDSAPrivateKey_Call) RunAndReturn(run func(string) (*ecdsa.PrivateKey, error)) *EcdsaKeyPairMock_ParseECDSAPrivateKey_Call {
	_c.Call.Return(run)
	return _c
}

// ParseECDSAPublicKey provides a mock function with given fields: pemKey
func (_m *EcdsaKeyPairMock) ParseECDSAPublicKey(pemKey string) (*ecdsa.PublicKey, error) {
	ret := _m.Called(pemKey)
...
func (_c *EcdsaKeyPairMock_ParseECDSAPublicKey_Call) RunAndReturn(run func(string) (*ecdsa.PublicKey, error)) *EcdsaKeyPairMock_ParseECDSAPublicKey_Call {
	_c.Call.Return(run)
	return _c
}
